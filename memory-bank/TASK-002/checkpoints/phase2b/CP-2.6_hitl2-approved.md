...
progress:
  completed:
    - "AskUserQuestion으로 테스트 결과 요약(6/6 실패, 인벤토리 일치, tsc 오류 0건) 제시"
    - "사용자 승인 수신 — '승인' 선택"
    - "TEST_TASK-002.json human_review.approved true로 변경"
  in_progress: "없음"
  blocked: []

next_steps:
  - priority: 1
    task: "wf-develop 스킬로 Phase 3 진입 — 6개 테스트를 통과시키는 최소 구현"
...
approval:
  ...
  question: "TASK-002 Phase 2b Red 테스트(SC-01~06, 6건 전부 실패)를 승인하시겠습니까?"
  answer: "승인"
---
