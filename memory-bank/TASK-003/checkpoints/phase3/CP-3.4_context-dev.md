...
checkpoint_name: "DEV_TASK-003.json 저장 완료"
task_id: TASK-003
phase: "3"
...
progress:
  completed:
    - "DEV_TASK-003.json 저장 — changed_files 10건, test_status green, lint error 0"
    - "리팩토링 없음으로 결정(CP-3.3)"
...
next_steps:
  ...
  - priority: 2
    task: "wf-verify 스킬로 Phase 4 진입 — SC-06(서체 폴백)의 실브라우저 확인을 반드시 수행"
...
execution_context:
  ...
  main_files:
    - "workflow_design/06_dev/DEV_TASK-003.json"
---
